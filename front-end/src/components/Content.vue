    ...
    <div id="CT">
      <div id="CT_image">
        ...
        >
          ...
          <div class="demo-image__preview2">
            ...
            <div class="img_info_1" style="border-radius: 0 0 5px 5px">
              <span style="color: white; letter-spacing: 4px">處理结果</span>
            </div>
          </div>
        </el-card>
      </div>
      ...
      <div id="info_patient">
        ...
        <el-card style="border-radius: 8px">
          ...
          <el-select v-model="selectedFunction" placeholder="选择图像处理功能">
            <el-option label="圖像平滑" value="image_smooth"></el-option>
            <el-option label="图像增強" value="image_enhancement"></el-option>
            <el-option label="邊緣檢測" value="edge_detection"></el-option>
          </el-select>
        </el-card>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      selectedFunction: "image_smooth",  // 默认选中物体检测
      url_1: "",
      url_2: "",
      textarea: "",
      srcList: [],
  ...
  methods: {
    ...
    update(e) {
      ...
      param.append("function", this.selectedFunction); // 选择的图像处理功能
